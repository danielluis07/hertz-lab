...
/**
 * Which Better Auth error code gets which sentence. The codes are domain facts
 * about signing in rather than transport facts, so this copy is a rule owned by
 * the auth module and not a shape in the global layer (ADR-0013).
 */
