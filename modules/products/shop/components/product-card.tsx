...
export function ProductCard({
  ...
  priority?: boolean;
  /**
   * The name's level in the page outline: `h2` under a page `<h1>` (the
   * catalogue), `h3` under a section `<h2>` (`/`'s Product previews).
   */
  headingLevel?: "h2" | "h3";
}) {
  ...
  return (
    <article className="group/card relative flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-1">
        ...
        <Heading className="line-clamp-2 text-base font-medium">
          <Link
